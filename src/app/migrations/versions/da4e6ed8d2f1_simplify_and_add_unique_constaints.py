...
def upgrade():
    ...
    op.alter_column("currency", "name", existing_type=mysql.VARCHAR(length=20), nullable=True)
...
def downgrade():
    ...
    op.alter_column("currency", "name", existing_type=mysql.VARCHAR(length=20), nullable=False)

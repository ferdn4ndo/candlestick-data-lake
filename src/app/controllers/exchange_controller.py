...
from app.services.exchanges.exchange_service_factory import ALLOWED_EXCHANGE_CODES, create_exchange_service_from_code, \
    serialize_existing_exchanges, create_exchange_service_from_model
...
class ExchangeListController(BaseController):
    ...
    def post(self) -> None:
        ...
        try:
            ...
            self.send_error_response(
                status_code=409,
                message=f"The code '{code}' is already registered."
            )
...
class ExchangeSingleController(BaseController):
    def get(self, **kwargs) -> None:
        ...
        try:
            ...
            self.send_error_response(
                status_code=404,
                message=f"The exchange ID '{exchange_id}' was not found."
            )

...
from app.services.exchanges.exchange_service_factory import ALLOWED_EXCHANGE_CODES, create_exchange_service_from_code, get_exchange_by_id, \
...
class ExchangeSetupController(BaseController):
    ...
    def post(self, **kwargs) -> None:
        ...
        try:
            ...
            self.send_error_response(
                status_code=500,
                message=f"Error while executing client for exhange '{exchange_code}'!"
            )

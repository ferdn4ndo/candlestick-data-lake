...
def upgrade():
    ...
    sa.Column('created_at', sa.DateTime(timezone=True), nullable=True),
    sa.Column('upated_at', sa.DateTime(timezone=True), nullable=True),
    sa.ForeignKeyConstraint(['currency_a_id'], ['currency.id'], ),
    sa.ForeignKeyConstraint(['currency_b_id'], ['currency.id'], ),
    ...
    sa.Column('created_at', sa.DateTime(timezone=True), nullable=True),
    sa.Column('upated_at', sa.DateTime(timezone=True), nullable=True),
    sa.ForeignKeyConstraint(['currency_pair_id'], ['currency_pair.id'], ),
    sa.PrimaryKeyConstraint('id')
    )
